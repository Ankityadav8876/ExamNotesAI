  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8">
      <motion.header
        ...
        className="mb-10  rounded-2xl bg-black/80 backdrop-blur-xl border border-white/10 px-8 py-6 shadow-[0_20px_25px_rgba(0,0,0,0.6)] items-start flex md:items-center justify-between gap-4 flex-col md:flex-row"
      >
      ...
      <motion.div className="mb-12">
        <TopicForm
          loading={loading}
          setLoading={setLoading} // fix this line
          setResult={setResult}
          setError={setError}
        />
      </motion.div>
