  ...
  `}
      ...
      {!quickRevision && (
        <section>
          <SectionHeader
            icon="⭐"
            title="Sub Topics (Priority Wise)"
            color="indigo"
          />
      ...
      {quickRevision && (
        <section
          className="rounded-xl bg-gradient-to-r from-green-100 to-green-50 border 
...
function SectionHeader({ icon, title, color }) {
  ...
  return (
    <div
      className={`
        mb-4 px-4 py-2 rounded-lg bg-gradient-to-r ${colors[color]}
        font-semibold flex itmes-center gap-2 `}
    >
      <span>{icon}</span>
      <span>{title}</span>
    </div>
